...
import shutil
import time
from modules.utils.android_case import Case
from modules.utils.android_TSK import TSK
from modules.scanner.android_image_info_extractor import ImageInfo
from modules.scanner.android_system_log_info_extractor import SystemLog
from modules.preprocessor.android_data_classifier import Classifier
from modules.preprocessor.android_file_extractor import FileExtractor
from modules.preprocessor.android_apk_decompiler import APKDecompiler
from modules.preprocessor.android_sqlitedb_analyzer import SQLiteAnalyzer
from modules.analyzer.android_data_analyzer import DataAnalyzer
...
def main(args):
    ...
    for image_file_path in list_image_file_path:
        ...
        if (args.phase == None) | (args.phase == "preproc"):
        ...
        if (args.phase == None) | (args.phase == "analysis"):
